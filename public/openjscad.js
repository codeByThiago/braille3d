...
OpenJsCad.checkResult = function (result) {
  ...
  if (!ok) {
    throw new Error(
      "Your main() function does not return valid data. It should return one of the following: a CSG object, a CAG object, or an array of objects: [{name:, caption:, data:}, ...] where data contains a CSG or CAG object."
    );
  }
};
...
OpenJsCad.parseJsCadScriptASync = function (
  ...
  var baselibraries = ["csg.js", "openjscad.js"];
...
*/
  ...
  abort: function () {
    if (this.processing) {
      //todo: abort
      this.processing = false;
      this.statusspan.innerHTML = "Cancelado.";
